        ...
        <div>
            ...
            <div className='container m-auto mt-5 table-responsive  table-responsive-sm table-responsive-md' >
                <table className='table table-hover '>
                    <thead className=' fs-4' style={{ backgroundColor: "green" }}>
                        <tr>
                            <th scope='col' >#</th>
                ...
                <div>
                    <button className='btn mt-5 ' onClick={handleCheckOut} style={{ backgroundColor: "lightgreen", color:"black", marginLeft:"80%" }} > Check Out </button>
                </div>
            </div>
